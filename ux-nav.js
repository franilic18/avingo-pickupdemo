...
draw=function(){uxBaseDraw();if(us==='home')return;const navTop=document.querySelector('.u-top');if(!navTop)return;const b=document.createElement('button');b.className='u-back';b.textContent='←';b.setAttribute('aria-label','Back');b.onclick=()=>{us=UXBACK[us]||'home';draw()};navTop.prepend(b)};
